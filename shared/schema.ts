...
export const nonprofitDesigns = pgTable("nonprofit_designs", {
  ...
  designType: text("design_type").notNull().default("store_post"),
  projectType: text("project_type").notNull().default("general_charity"),
  projectName: text("project_name").notNull(),
  highlightWord: text("highlight_word").notNull(),
  primaryColor: text("primary_color").notNull(),
  visualContext: text("visual_context").notNull(),
  logoUrl: text("logo_url"),
  extractedColors: text("extracted_colors"),
