            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              {error && (
                <motion.div 
                  ...
                  className={
                    error.includes('بانتظار موافقة الإدارة')
                      ? "flex items-center gap-3 p-4 rounded-xl bg-yellow-500/10 border border-yellow-500/25 text-yellow-600 dark:text-yellow-500 text-sm"
                      : "flex items-center gap-3 p-4 rounded-xl bg-red-500/10 border border-red-500/25 text-red-500 dark:text-red-400 text-sm"
                  }
                >
